  ...
  return (
    <div className="w-11/12 h-24 m-auto flex bg-slate-50 mb-8 ">
      <Link to="/" className="w-4/12 flex ">
        <img src="https://static.vecteezy.com/system/resources/thumbnails/027/765/346/small_2x/quiz-sign-mark-free-free-png.png" alt="" />
      </Link>

      <div className="w-2/5 ml-14 ">
        {/* <img className="w-96 h-24" src={'./images.png'} alt="" /> */}
      </div>
